...
class IssueAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'desc', 'tag', 'priority', 'created_time',
                    'assignee_user', 'author_user', 'project', 'status')
    list_filter = ('id', 'title', 'tag', 'priority', 'created_time',
                   'assignee_user', 'author_user', 'project', 'status')
...
class CommentsAdmin(admin.ModelAdmin):
    list_display = ('id', 'description', 'created_time',
                    'author_user', 'issue')
